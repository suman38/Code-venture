...
public class HomeScene extends Scene implements ActionListener {
	...
	public HomeScene(Engine engine) {
		super(engine);
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			engine.showScene(SceneType.GAME);
		}
		else if (e.getSource() == bLoad) 
		{
			Player p = engine.deserializePlayer();
			if (p != null) 
			{
				//load game scene with updated data
				engine.setPlayer(p);
				engine.showScene(SceneType.GAME);
